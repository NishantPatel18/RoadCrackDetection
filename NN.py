...
# Validating the Model
    ...
    end_val = time.time()
    print('Finished Validating in %0.2f minutes' % ((end_val - start_val) / 60))
    ...
    print('Total Time for Training and Validating in %0.2f minutes' % ((end_val - start_train) / 60))
